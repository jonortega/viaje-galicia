...
export const trip: Trip = {
  ...
  places: [
    ...
    },
    {
      ...
      description: "Centro histórico de Santiago, con el Obradoiro y las plazas previstas para la primera mañana.",
    ...
    },
    {
      ...
      description: "Posible parada en el centro de Sanxenxo, con la plaza de Pascual Veiga como referencia.",
    ...
    },
    {
      ...
      description: "Posible parada en el puerto de Portonovo durante el día de plan abierto.",
    ...
    },
    {
      ...
      description: "Posible parada en el núcleo marinero de Corrubedo, en la costa de Barbanza.",
    ...
    },
    {
      ...
      description: "Posible paseo hasta las pozas naturales del río Pedras, en A Pobra do Caramiñal.",
    ...
    },
    {
      ...
      category: "alojamiento",
      coordinates: { lat: 42.9687859, lng: -8.4417454 },
      description: "Punto de referencia en el centro de Sigüeiro para la llegada al alojamiento de la última noche.",
